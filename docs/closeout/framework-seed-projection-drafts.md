...
Intended action: create the Published PRD Issue for `docs/prd/framework-seed.md`
...
Status: Implemented in branch `metasmith-framework`; pending PR publication.

Repo draft: `docs/prd/framework-seed.md`

## Success Criteria

- The Framework Seed preserves the Source Handoff as provenance and projects
  accepted requirements into repo-native docs, templates, examples, specs,
  validators, and closeout evidence.
- Root `AGENTS.md` gives Smiths the zero-scout Framework Path, including
  Framework requirement escalation and Story Closeout routing.
- Root `README.md` remains the Human Framework Entry and avoids agent-only
  policy detail.
- Canonical Framework docs describe equipment vocabulary, runbooks, harness
...
- `docs/metasmith/source-projection.md` for requirement disposition and
  validation status;
- canonical Framework docs under `docs/`;
...
- Framework requirement escalation from Smith to Metasmith;
- Story Closeout, security closeout, documentation closeout, and projection
  draft surfaces;
- `tools/validate_framework_seed.py` and its test suite.
...
- `python3.14 tools/validate_framework_seed.py --json`: 174 passing result
  objects.
- `python3.14 tools/validate_framework_seed.py --final-closeout`: 0 failed,
  175 passed.
...
- Security closeout: `docs/security/framework-seed-closeout.md`
...
canonical Framework docs, PRD, ADRs, plan, source projection, security docs,
...
Closeout, Framework requirement escalation, Source Projection Register status
...
Framework Seed coherent across PRD, plan, canonical docs, validation, security,
...
```text
feat(framework): implement framework seed
```
...
- Preserve and project the Source Handoff into canonical Framework docs,
  templates, examples, specs, validators, and closeout evidence.
- Add Framework requirement escalation, Story Closeout, security closeout,
...
No release publication is planned for the Framework Seed. The Seed is a branch
...
- `docs/closeout/framework-seed-documentation.md`,
- `docs/security/framework-seed-closeout.md`,
...
treating the Framework Seed as fully closed. If the operator explicitly holds or
