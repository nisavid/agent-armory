...
| `docs/closeout/forge-seed-follow-up-projection.md` | Retired capture projection | Forge Seed closeout | Durable projection and source-disposition evidence | Forgewrights and agents auditing Seed-era follow-up disposition | Updated only when the retired capture projection evidence changes; active follow-up work lives in GitHub Issues |
