...
def rewrite_migration_source(layer: Layer, fragment: SchemaFragment, migration: MigrationPreview) -> None:
    ...
    *,
    ...
    for layer in layers:
        ...
        for fragment in fragments:
            ...
            elif (safety_reason := migration_apply_safety_refusal_reason(effective)) is not None:
            ...
            if reason is not None:
                ...
                continue
            decision = "applied" if apply else "dry_run"
            record = migration_apply_audit_record(
                layer,
                fragment,
                from_version=source_version,
            ...
            if apply:
                rewrite_migration_source(layer, fragment, migration)
    ...
    return {
        ...
        "applied": any(application["decision"] == "applied" for application in applications),
...
def build_parser() -> argparse.ArgumentParser:
    ...
    migration.add_argument("--apply-authority")
