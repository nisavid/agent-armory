...
| --- | --- | --- | --- | --- | --- | --- |
| SP-001 | accepted | codex, claude_code, cursor, hermes_agent, opencode, openclaw | Current releases or changelog state differ from migrated profile versions: [Codex](https://github.com/openai/codex/releases/tag/rust-v0.130.0), [Claude Code](https://github.com/anthropics/claude-code/releases/tag/v2.1.138), [Cursor](https://cursor.com/changelog/05-07-26), [Hermes](https://github.com/NousResearch/hermes-agent/releases/tag/v2026.5.7), [OpenCode](https://github.com/anomalyco/opencode/releases/tag/v1.14.46), [OpenClaw](https://github.com/openclaw/openclaw/releases/tag/v2026.5.7) | `[[version_observation]] observed_version = "rust-v0.130.0"; canonical_profile_change = true` | Require checked-at, observed version, whether the observation changes canonical profile claims, and source URL for source-backed observations. | Canonical profiles carry one current version observation per supported harness. |
